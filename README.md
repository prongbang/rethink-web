...
```
$ docker-machine create -d virtualbox rethink-frontend
$ docker-machine env rethink-frontend
$ eval $(docker-machine env rethink-frontend)
```
...
```
$ docker run -it \
  -v ${PWD}:/usr/src/rethink-web \
  -v /usr/src/rethink-web/node_modules \
  -p 3000:3000 \
...
$ docker-machine rm rethink-frontend
```
